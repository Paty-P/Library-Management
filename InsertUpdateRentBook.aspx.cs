    ...
    public partial class WebForm22 : System.Web.UI.Page
    {
        ...
        protected void ButtonSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@registration_number  ", TextBoxRegistrationNumber.Text);
                cmd.Parameters.AddWithValue("@borrow_date  ", CalendarBorrowdate.SelectedDate);
        ...
        protected void MethodUpdateRentBook()
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@return_date", CalendarReturnDate.SelectedDate);
        ...
        protected void CalendarReturnDate_SelectionChanged(object sender, EventArgs e)
        {
            ...
            TextBoxReturndate.Text = CalendarReturnDate.SelectedDate.ToString("yyyy-MM-dd");
            CalendarReturnDate.Visible = false;
